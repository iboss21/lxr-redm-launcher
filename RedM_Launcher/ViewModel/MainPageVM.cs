...
namespace RedM_Launcher.ViewModel
{
    ...
    class MainPageVM : INotifyPropertyChanged
    {
        ...
        public bool IsLaunched
        {
            ...
            set { _isLaunched = value; OnPropertyChanged(); OnPropertyChanged("ShouldHide"); }
        }
        ...
        private void ResetStateLaunch()
        {
            ...
            if (Settings.Default.IsHideLauncherWhenRedMRunning)
            {
